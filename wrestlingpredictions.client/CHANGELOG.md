...
- Create Angular project with ng: `ng new wrestlingpredictions.client --defaults --skip-install --skip-git `.
...
- Create project file (`wrestlingpredictions.client.esproj`).
